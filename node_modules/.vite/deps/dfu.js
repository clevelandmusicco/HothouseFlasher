...
function u(e) {
  ...
  for (; i2.byteLength > 2; ) {
    ...
    if (4 == s2) t2 = d(o2), r2 = 254 == t2.bInterfaceClass && 1 == t2.bInterfaceSubClass, n2.push(t2);
    else if (r2 && 33 == s2) {
      let e3 = a(o2);
...
var g = class {
  ...
  do_dfuse_write(e, n2, s2) {
    ...
    return t(this, void 0, void 0, function* () {
      ...
      if (isNaN(d2)) {
        if (d2 = null === (o2 = this.dfuseMemoryInfo.segments[0]) || void 0 === o2 ? void 0 : o2.start, !d2) throw new r("startAddress not found");
  ...
  do_dfuse_read(e, n2, s2 = 1 / 0) {
    ...
    return t(this, void 0, void 0, function* () {
      ...
      if (isNaN(t2)) {
        if (t2 = null === (o2 = this.dfuseMemoryInfo.segments[0]) || void 0 === o2 ? void 0 : o2.start, !t2) throw new r("Unknown memory segments");
